...
| Data Acquizition                                   | - Querying data - Pulling data from a database<br>-  Creating a data model -Building databases (SQL, NoSQL, MySQL, Cassandra, etc.) to store data and facilitating access by other team members                                                                                                                                                                                                                                                               |       |
| Data Exploration                                   | - Exploration via Data visualization <br>- Applying a dimensionality reduction on a dataset to facilitate model training or gather insights                                                                                                                                                                                                                                                                                                                   |       |
| Data Cleaning                                      | - Get into Tidy data                                                                                                                                                                                                                                                                                                                                                                                                                                          |       |
| Querying data                                      | - Pulling data from a database (SQL or NOSQL)                                                                                                                                                                                                                                                                                                                                                                                                                 |       |
| Data Preparation/Feature Engineering               | - Feature Selection<br>- Feature Encoding                                                                                                                                                                                                                                                                                                                                                                                                                     |       |
...
| Building APIs for an application to use a model    | - Setting up HTTP RESTful API services to facilitate communications between software components - Setting up authorization and authentication to access the API                                                                                                                                                                                                                                                                                               |       |
